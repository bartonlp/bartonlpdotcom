<?php
// Site class file for bartonlp.com
namespace Blp;
use SiteClass\SiteClass;
...
class Blp extends SiteClass {
  ...
  // BLP 2014-11-09 -- add statcounter, see footer.i.php
  ...
  public function getFooter(/* mixed */) {
    ...
    if($n == 1) {
      ...
      $keys = array('msg', 'w3cmsg', 'ctrmsg', 'google', 'statcounter');
      $ar = array();
      for($i=0; $i < $n; ++$i) {
        $ar[$keys[$i]] = $args[$i];
      }
    ...
    $arg['msg'] = $arg['msg'] . "<p style='text-align: center'>Counter Reset 2014</p>";
