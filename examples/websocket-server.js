#!/usr/bin/env node
// BLP 2014-10-30 -- continue work on messages etc.
// BLP 2014-10-12 -- add logging both syslog and websocket.log in
// /var/www/html/. Force owner to barton and group to www-data and make
// /mode 0664
// NOTE: this is run via upstart see the websocket.conf here and in
// /etc/init
...
var server = http.createServer(function(request, response) {
  ...
  response.end("<h1>403 Forbiden</h1><h2>Go Away</h2><p>This port is used for WebSockets</p>");
});
